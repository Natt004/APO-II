...
public class Operacion {
	...
	System.out.println("El motor es:  " +Engine.getMake());

	System.out.println("El motor tiene una capacidad de:  " +Engine.getCapacity() +" cc");
	...
	Vehicle.Engine vehicle3 = new Vehicle.Engine("Fortuna");
	
	System.out.println("El vehiculo numero "+vehicle3.getChassisNo() +" es un modelo " +vehicle3.getModel() +" y tiene una capacidad de motor de "  +vehicle3.getCapacity() +"cc");
